    ...
    return (
        <header className="sticky top-0 z-50 flex flex-row justify-between items-center px-8 py-3 bg-white border-b border-gray-200">
            <div className="flex flex-row justify-center items-center gap-4">
                <Link to="/home" className="flex flex-row items-center justify-center gap-2 px-4 py-2.5 bg-gray-100 border-none font-bold rounded-lg text-gray-700 cursor-pointer transition-transform duration-150 active:scale-95">
